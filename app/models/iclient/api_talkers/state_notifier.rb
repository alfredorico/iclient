module Iclient
  module ApiTalkers
    class StateNotifier < Inspection
      
      include ::Iclient::NotifyLogger 

      def data
        @data ||= StateResponseBuilder.find(self.id).data
      end
      ...
      def url
        ENV['ICLIENT_UPDATE_STATE_URL'] || 'https://www.iclient.com/Corporate/Web/Proveedor/api/inspeccion/actualizarestado'
      end
