module Iclient
  module ApiTalkers
    class AccessoriesNotifier < Inspection

      include ::Iclient::NotifyLogger 

      def data
        @data ||= AccessoriesResponseBuilder.find(self.id).data
      end
      ...
      def url
        ENV['ICLIENT_ACCESORIES_URL'] || 'https://www.iclient.com/Corporate/Web/Proveedor/api/inspeccion/accesorios'
      end
